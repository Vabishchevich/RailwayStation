...
<html>
    ...
    <body>
        ...
        <div class = "container" style="width:550px;font-style:italic;opacity:0.8;margin-top:80px">
            <div style="text-align:center;"><h3>Выбор маршрута:</h3></div>
            <form method="post" action="/Controller" class="well">
                ...
                <div class = "form-group">
                    <label> Введите дату отправления:  </label>
                ...
                <input type = "submit" class="btn btn-secondary btn-block" name = "command" value="Поехали">
            </form>
        </div>
