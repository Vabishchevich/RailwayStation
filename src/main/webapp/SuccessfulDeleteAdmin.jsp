...
<html>
    ...
    <body>
        <nav class="navbar navbar-inverse navbar-fixed-top" style="font-style:italic;opacity:0.8">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a>Добавление нового поезда</a></li>
                    <li><a>Выйти</a></li>
                </ul>
            </div>
        </nav>   
        <div class="container" style="font-style:italic;opacity:0.8;margin-top:80px">
            <div class="alert alert-success" role="alert">
                <h3 style="text-align:center">Успех</h3>
                <hr>
                <div style="text-align:center">Пользователь успешно удалён</div>
            </div>  
        </div>
        <div class="footer">
    ...
    <script>
        setTimeout(function () {
            document.location.replace("/AdminHomePage.jsp");
        }, 5000);
    </script>
</html>