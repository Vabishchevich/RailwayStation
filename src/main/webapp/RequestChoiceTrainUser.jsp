...
<html>
    ...
    <body>
        ...
        <div class = "container" style="font-style:italic;opacity:0.8;margin-top:80px">
            <div style="text-align:center;"><h3>Выбор поезда:</h3></div>
            <form method="GET" action="/Controller" class="well">
                ...
                <div style="text-align:center">
                    <label> Выберите номер поезда: </label>
                </div>
                <select name="numberTrain" class="form-control">
                    <c:forEach var="train" items="${listOfTrains}">
                        <option>${train.getNumberTrain()}</option>
                    </c:forEach>
                </select>
                <br><br><br>
                <input type="submit" class="btn btn-secondary btn-block" name="command" value="Продолжить">
                <br>
            </form>
        </div>
